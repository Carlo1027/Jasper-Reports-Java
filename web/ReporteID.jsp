<%-- 
    Document   : ReporteID
    Created on : 18/08/2015, 12:42:00 PM
    Author     : Carlo Castro
--%>
...
<%  
	...
	String per_id_persona=request.getParameter("idcliente");
	...
	parameters.put("idcliente", per_id_persona); 
	/*Enviamos la ruta del reporte, los parámetros y la conexión(objeto Connection)*/ 
	byte[] bytes = JasperRunManager.runReportToPdf(reportFile.getPath (), parameters, conexion.Conexion()); 
