...
<html>
    ...
    <body background="imags/fondo1.jpg" style="background-size: cover;-moz-background-size: cover;-webkit-background-size: cover;-o-background-size: cover;">
        ...
        <%
            if(request.getParameter("serialdocu").trim()!=null&&request.getParameter("fechadocu").trim()!=null&&request.getParameter("fechadocu1").trim()!=null&&Integer.parseInt(request.getParameter("folios"))>=0&&Integer.parseInt(request.getParameter("rangoinf"))>=0&&Integer.parseInt(request.getParameter("rangosup"))>=0&&Integer.parseInt(request.getParameter("caja"))>=0&&Integer.parseInt(request.getParameter("paquete"))>=0){
            
                Registro reg = new Registro(request.getParameter("serialdocu"),request.getParameter("fechadocu"),request.getParameter("fechadocu1"),Integer.parseInt(request.getParameter("folios")),Integer.parseInt(request.getParameter("rangoinf")),Integer.parseInt(request.getParameter("rangosup")),Integer.parseInt(request.getParameter("caja")),Integer.parseInt(request.getParameter("paquete")),0);
